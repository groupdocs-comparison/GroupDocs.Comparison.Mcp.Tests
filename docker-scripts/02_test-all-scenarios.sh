#!/bin/bash
################################################################################
# GroupDocs.Comparison.Mcp — Integration Test Runner (local)
#
...
#   - Compare (source vs target diff across PDF/Word/Excel/PowerPoint)
#   - GetDocumentInfo (file type, page count, size, per-page dimensions)
...
#   --filter PATTERN        Run only tests matching pattern (e.g., Compare)
...
#   ./02_test-all-scenarios.sh --version 26.5.1 --filter Compare
...
TEST_PROJECT_DIR="$PROJECT_ROOT/src/GroupDocs.Comparison.Mcp.Tests"
...
main() {
    ...
    echo ""
    echo "╔════════════════════════════════════════════════════════════╗"
    echo "║  GroupDocs.Comparison.Mcp — Integration Test Runner (local) ║"
    echo "╚════════════════════════════════════════════════════════════╝"
    echo ""
