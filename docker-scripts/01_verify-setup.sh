...
main() {
    echo ""
    echo "╔════════════════════════════════════════════════════╗"
    echo "║  GroupDocs.Comparison.Mcp — Setup Verification      ║"
    echo "╚════════════════════════════════════════════════════╝"
    echo ""
    ...
    # Check test project
    if [ -d "$PROJECT_ROOT/src/GroupDocs.Comparison.Mcp.Tests" ]; then
        print_pass "Test project found"
    else
        print_fail "Test project not found: $PROJECT_ROOT/src/GroupDocs.Comparison.Mcp.Tests"
    fi
    
    # Check csproj
    if [ -f "$PROJECT_ROOT/src/GroupDocs.Comparison.Mcp.Tests/GroupDocs.Comparison.Mcp.Tests.csproj" ]; then
    ...
    local mcp_image="ghcr.io/groupdocs-comparison/comparison-net-mcp:latest"
