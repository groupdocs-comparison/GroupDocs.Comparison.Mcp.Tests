#!/bin/bash
################################################################################
# GroupDocs.Comparison.Mcp — Docker-Compose Integration Test Runner
#
...
#   ./03_test-docker-compose.sh --filter Compare --keep
#
################################################################################
...
services:
  test-runner:
    ...
    working_dir: /workspace/src/GroupDocs.Comparison.Mcp.Tests
    environment:
      DOTNET_NOLOGO: "true"
...
main() {
    ...
    echo ""
    echo "╔════════════════════════════════════════════════════╗"
    echo "║  GroupDocs.Comparison.Mcp — Docker Test Runner      ║"
    echo "╚════════════════════════════════════════════════════╝"
    echo ""
