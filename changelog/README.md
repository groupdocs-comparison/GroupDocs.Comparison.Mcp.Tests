...
Per-change notes for the GroupDocs.Comparison.Mcp integration tests repo, captured
...
id: 001
date: 2026-04-23
package-under-test: 26.5.0   # version of GroupDocs.Comparison.Mcp the suite targets
...
`package-under-test` field records which `GroupDocs.Comparison.Mcp` version the
