...
internal static class MeteredKeys
{
    ...
    /// <summary>
    /// Fails loudly when the metered key pair is absent.
    /// </summary>
    /// <remarks>
    ...
    /// overstates coverage — the metered job is gated in CI, where the decision is
    /// visible, so by the time a test runs the keys must be there.
    /// </remarks>
